const translations = {
    ...
    pt: {
        ...
        notification_body: "Você tem uma nova mensagem do suporte.",
        viewAll: "Ver Todos",
        all: "Todos",
        newOrder: "Nova OS",
        ...
        orderCreatedMsg: "Nova ordem de serviço adicionada com sucesso.",
        ...
        patternLock: "Padrão de Desenho",
        clear: "Limpar",
        services: "4. Serviços a Serem Executados",
        svc_budget: "Avaliação para orçamento",
        ...
        svc_board: "Reparo de Placa Mãe",
        svc_cam_rear: "Troca de Câmera Traseira",
        svc_cam_front: "Troca de Câmera Frontal",
        svc_speaker: "Troca de Alto-Falante",
        svc_water: "Reparo de Água/Oxidação",
        svc_software: "Atualização de Software",
        svc_backup: "Backup e Transferência",
        ...
        housingDamage: "Tem danos na carcaça?",
        media: "11. Fotos e Vídeos",
        photoIn: "Foto - Entrada",
        photoOut: "Foto - Saída",
        budgetPayment: "14. Orçamento e Pagamento",
        serviceValue: "Valor do Serviço (R$)",
        productsValue: "Valor dos Produtos (R$)",
        discount: "Desconto (R$)",
        totalValue: "Valor Total (R$)",
        printType: "Tipo de Impressão",
        generateOrder: "Gerar Ordem de Serviço",
        inventory: "Estoque",
        expenses: "Despesas",
    ...
    es: {
        ...
        orderCreatedMsg: "Nueva orden de servicio añadida con éxito.",
        clientCreated: "Cliente Creado",
        clientCreatedMsg: "Nuevo cliente añadido con éxito.",
        clientList: "Lista de Clientes",
        ...
        emailNotifDesc: "Recibir correos sobre nuevas órdenes.",
        autoRefresh: "Actualización Automática",
        autoRefreshDesc: "Actualizar datos del tablero automáticamente.",
        welcomeBack: "Bienvenido de Nuevo",
        loginSubtitle: "Por favor ingrese sus datos para iniciar sesión.",
        password: "Contraseña",
        signIn: "Iniciar Sesión",
        loginSuccess: "Inicio de Sesión Exitoso",
        loginSuccessMsg: "¡Bienvenido de nuevo, John Doe!",
        ...
        patternLock: "Patrón de Bloqueo",
        clear: "Limpiar",
        services: "4. Servicios a Realizar",
        svc_budget: "Evaluación para presupuesto",
        svc_screen: "Reemplazo de Pantalla",
        svc_glass: "Reemplazo de Vidrio",
        svc_battery: "Reemplazo de Batería",
        svc_charging: "Reemplazo de Puerto de Carga",
        svc_board: "Reparación de Placa Madre",
        svc_cam_rear: "Reemplazo de Cámara Trasera",
        svc_cam_front: "Reemplazo de Cámara Frontal",
        svc_speaker: "Reemplazo de Altavoz",
        svc_water: "Reparación de Daños por Agua",
        svc_software: "Actualización de Software",
        ...
        deadline: "6. Plazo",
        checklist: "7. Lista de Verificación",
        wet: "¿Mojado?",
        charging: "¿Cargando?",
        turnsOn: "¿Enciende?",
        housingDamage: "¿Daños en Carcasa?",
    ...
    fr: {
        ...
        cancel: "Annuler",
        save: "Sauvegarder",
        orderCreated: "Ordre Créé",
        orderCreatedMsg: "Nouvel ordre de service ajouté avec succès.",
        clientCreated: "Client Créé",
        clientCreatedMsg: "Nouveau client ajouté avec succès.",
        ...
        clientData: "1. Données Client",
        needsDelivery: "Livraison Nécessaire",
        deviceData: "2. Données Appareil",
        brand: "Marque",
        model: "Modèle",
        serial: "Série",
        imei: "IMEI",
        ...
        security: "3. Sécurité",
        patternLock: "Schéma de Verrouillage",
        clear: "Effacer",
        services: "4. Services à Effectuer",
        svc_budget: "Évaluation pour devis",
        svc_screen: "Remplacement Écran",
        svc_glass: "Remplacement Vitre",
        svc_battery: "Remplacement Batterie",
        svc_charging: "Remplacement Port de Charge",
        svc_board: "Réparation Carte Mère",
        svc_cam_rear: "Remplacement Caméra Arrière",
        svc_cam_front: "Remplacement Caméra Avant",
        svc_speaker: "Remplacement Haut-parleur",
        svc_water: "Réparation Dégâts des Eaux",
        svc_software: "Mise à jour Logicielle",
        ...
        deadline: "6. Délai",
        checklist: "7. Liste de Contrôle",
        wet: "Mouillé?",
        charging: "Charge?",
        turnsOn: "S'allume?",
        housingDamage: "Dommages Boîtier?",
        media: "11. Photos et Vidéos",
        photoIn: "Photo - Entrée",
    ...
    de: {
        ...
        orderCreatedMsg: "Neuer Serviceauftrag erfolgreich hinzugefügt.",
        clientCreated: "Kunde Erstellt",
        clientCreatedMsg: "Neuer Kunde erfolgreich hinzugefügt.",
        ...
        emailNotifDesc: "E-Mails über neue Aufträge erhalten.",
        ...
        loginSuccessMsg: "Willkommen zurück, John Doe!",
        logout: "Abmelden",
        // New Service Order Translations (German placeholders)
        clientData: "1. Kundendaten",
        needsDelivery: "Lieferung Erforderlich",
        deviceData: "2. Gerätedaten",
        brand: "Marke",
        model: "Modell",
        serial: "Seriennummer",
        imei: "IMEI",
        color: "Farbe",
        capacity: "Kapazität (GB)",
        security: "3. Sicherheit",
        patternLock: "Mustersperre",
        clear: "Löschen",
        services: "4. Durchzuführende Dienste",
        svc_budget: "Bewertung für Kostenvoranschlag",
        ...
        observations: "Zusätzliche Beobachtungen",
        chip: "5. Chip",
        withChip: "Mit Chip",
...
function renderSales() {
    ...
    sales.forEach(sale => {
        ...
        tr.innerHTML = `
            ...
            <td>${sale.total}</td>
            <td>${sale.payment}</td>
            <td><button class="action-btn" onclick="viewDetails('sale', '${sale.id}')">👁️</button></td>
        `;
        tbody.appendChild(tr);
    });
}
    ...
    invoices.forEach(inv => {
        ...
        tr.innerHTML = `
            ...
            <td>
                ...
                <button class="action-btn" onclick="viewDetails('invoice', '${inv.id}')">👁️</button>
            </td>
        `;
        tbody.appendChild(tr);
    });
